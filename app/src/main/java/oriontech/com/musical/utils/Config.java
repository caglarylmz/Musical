...
import oriontech.com.musical.MainActivity;
...
public final class Config
{
    ...
    public static final String YOUTUBE_API_KEY = "AIzaSyAjjgcrBCG5zGrTRr3N7zJHPwJ039-l7fs";

    // Media Session Token"
    public static final String INTENT_SESSION_TOKEN = "oriontech.com.musical.SESSION_TOKEN";
    ...
    public static final String ACTION_CMD = "oriontech.com.musical.ACTION_CMD";
    ...
    public static final String CUSTOM_ACTION_THUMBS_UP = "oriontech.com.musical.THUMBS_UP";
    public static final String EXTRA_START_FULLSCREEN = "oriontech.com.musical.EXTRA_START_FULLSCREEN";
     ...
     */
    public static final String EXTRA_CURRENT_MEDIA_DESCRIPTION = "oriontech.com.musical.CURRENT_MEDIA_DESCRIPTION";

    public static final String ACTION_PAUSE = "oriontech.com.musical.pause";
    public static final String ACTION_PLAY = "oriontech.com.musical.play";
    public static final String ACTION_PREV = "oriontech.com.musical.prev";
    public static final String ACTION_NEXT = "oriontech.com.musical.next";
    public static final String ACTION_STOP = "oriontech.com.musical.stop";
