...
import oriontech.com.musical.interfaces.IItemTouchViewListener;
...
public class SimpleItemTouchCallback extends ItemTouchHelper.Callback
{
    ...
    public SimpleItemTouchCallback(IItemTouchListener adapter)
    {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState)
    {
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            if (viewHolder instanceof IItemTouchViewListener) {
                // Let the view holder know that this item is being moved or dragged
                IItemTouchViewListener itemViewHolder = (IItemTouchViewListener) viewHolder;
