...
import oriontech.com.musical.utils.QueueHelper;

public class QueueManager
{
    private static final String TAG = LogHelper.makeLogTag(QueueManager.class);

    private IYouTubeVideoUpdateListener youTubeVideoUpdateListener;
    ...
    public QueueManager(@NonNull Resources resources,
                        @NonNull IYouTubeVideoUpdateListener listener)
    {
